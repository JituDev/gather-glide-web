        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Find events that match your interests with our advanced search and filtering options.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Simple Creation</h3>
              <p className="text-gray-600">Create and manage your own events with our intuitive event creation tools.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Meet like-minded people and build meaningful connections at every event.</p>
            </div>
          </div>
        </div>
      </section>
