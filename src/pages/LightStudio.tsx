...
const LightStudio = () => {
  ...
  // Filter venues for Light & Studio category
  const lightStudioVenues = venues.filter(venue => venue.category === 'Light & Studio');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8">
          ...
          <div className="w-80 space-y-6">
            {/* Light & Studio by Budget */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-4">Equipment by budget</h3>
            ...
            {/* Equipment by Type */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-4">Equipment by type</h3>
              <div className="grid grid-cols-2 gap-3">
                {venueTypes.map(type => (
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Light & Studio Equipment</h1>
                <p className="text-gray-600">Showing {lightStudioVenues.length} equipment providers as per your search criteria</p>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="relative">
                  ...
                  <Input
                    type="text"
                    placeholder="Search Light & Studio Equipment"
                    value={searchTerm}
