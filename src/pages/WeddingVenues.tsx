...
const WeddingVenues = () => {
  ...
  // Filter venues for Wedding Venues category
  const weddingVenues = venues.filter(venue => venue.category === 'Wedding Venues');
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Wedding Venues</h1>
                <p className="text-gray-600">Showing {weddingVenues.length} wedding venues as per your search criteria</p>
              </div>
