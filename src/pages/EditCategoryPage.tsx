...
const EditCategoryPage = () => {
  ...
  const { id } = useParams();
  const { categories, updateCategory, getCategories } = useAdmin();
  ...
  const [selectedSection, setSelectedSection] = useState<string>(''); // New state for section selection
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Modify your category structure and custom fields</p>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-800">Form Fields Configuration</h2>
            </div>
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              {formData.fields.length === 0 ? (
                <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                  ...
                  <p className="text-gray-500">No fields configured yet. Start by adding sections and fields above.</p>
                </div>
              ) : (
