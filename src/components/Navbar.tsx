...
//   ];
  ...
  const adminNavItems = [
    ...
    { path: "/admin/bookings", icon: Calendar, label: "BOOKING MGMT" },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between">
                  ...
                  <Link to="/" className="flex items-center gap-3">
                      ...
                      {/* Website Name */}
                      <span className="text-2xl font-extrabold tracking-wide text-white font-[Poppins]">
                          EventLoop
                      </span>
                  </Link>
                  ...
                  <div className="hidden md:flex items-center space-x-8 mx-auto">
                      ...
                      {commonNavItems.map((item, index) => (
                          <Link
                              ...
                              className="hover:text-purple-200 transition-colors flex items-center text-sm"
                          >
                  ...
                  {localCityName && (
                      <button
                          onClick={() =>
                              navigate("/ServicesPage", { state: { location: localCityName } })
                          }
